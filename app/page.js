        ...
        <div className="section-inner">
          ...
          <div className="steps-grid">
            ...
            <div className="step-card">
              ...
              <p>
                Cuando termine la instalación, abre cada herramienta en su dirección local correspondiente o en su dirreccion <a
  className="text-primary underline underline-offset-2 hover:text-accent transition-colors duration-200"href="/tutorial-ip">ip</a> si prefiere acceder desde otro dispositivo dentro de la misma red local.
              </p>
